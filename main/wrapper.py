...
class Group4ModelWrapper:
    def __init__(self, filename, model = "cracknet cutoff focal loss revised w augmentation part 3.pt.pt"):
        self.filename = filename
        self.DEVICE = "cpu"
        self.model = torch.load(model, weights_only=False, map_location=torch.device(self.DEVICE))
